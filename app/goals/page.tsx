...
export default function GoalsPage() {
  ...
  const fetchData = async () => {
    ...
    if (gRes.ok) {
      ...
      const weekGoal = (gdata.goals || []).find(
        (g: any) => g.type === "weekly",
      );
      const monthGoal = (gdata.goals || []).find(
        (g: any) => g.type === "monthly",
      );
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-600 mb-8">
        Plan your weekly workout schedule and set long-term fitness goals.
      </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-lg p-6 shadow">
          ...
          <div className="flex gap-2">
            ...
            />
            <button
              onClick={() => saveTarget("weekly", weeklyTarget)}
          ...
          <p className="mt-4 text-sm text-gray-600">
            Progress: {weeklyCount} / {weeklyTarget}
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow">
          ...
          <div className="flex gap-2">
            ...
            />
            <button
              onClick={() => saveTarget("monthly", monthlyTarget)}
              className="bg-blue-600 text-white px-4 py-2 rounded"
            >
              Save
            </button>
          ...
          <p className="mt-4 text-sm text-gray-600">
            Progress: {monthlyCount} / {monthlyTarget}
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow">
          ...
          <p className="text-gray-600">
            Assign workouts to weekdays and track progress here. Targets help
            you stay consistent.
          </p>
        </div>
      </div>
            ...
            return (
              <div key={d} className="border rounded p-4">
                <div className="flex justify-between items-center mb-2">
                  ...
                  {assigned ? (
                    <button
                      onClick={() => removeAssignment(assigned.id)}
                ...
                {assigned ? (
                  <div>
                    ...
                    <div className="text-sm text-gray-600">
                      {new Date(assigned.workout.date).toLocaleDateString()}
                    </div>
                  </div>
                ) : (
                  <select
                    onChange={(e) => assignWorkout(i, Number(e.target.value))}
                    defaultValue=""
                  >
